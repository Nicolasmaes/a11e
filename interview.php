...
<html lang="en">
    ...
    <div class="container">
        ...
        <div class="para">
            <p><span class="quest">Qu’est-ce qu’il y a comme différence entre une personne sourde de naissance et une qui l’est devenue après ?</span><br><br>
        ...
        <div class="para">
            <p><span class="quest">Comment se déroule les cours à distance ?</span><br><br>
            ...
            Il y a aussi des plates-formes sur Moodle, pour enseigner la LSF* à distance.
            En France il y a des écoles bilingues, donc l'enfant suit une scolarité standard, normale, avec des professionnelles en plus, donc ça se fait directement en LSF et a l'écrit.
            Il y a des écoles bilingues et des instituts spécialisés
            </p>
        </div>

        <div class="para">
            <p><span class="quest">Est-ce que c'est gratuit ?</span><br><br>
            Oui, après comme dans le système classique il y’a des écoles publiques. Les instituts spécialisés sont dépendants du ministère de la santé, parce qu'on considère toujours qu’être sourd c'est être malade, finalement. Alors que les écoles bilingues sont rattachées au Ministère de l’éducation.
            Il y’a une méthode qui s’appelle l'intégration : c'est-à-dire qu’on met un enfant sourd dans une classe d'entendants avec un AESH* qui répète à l'enfant. Mais il est vite noyé. Nous on est contre ce système d'intégration. L’épanouissement n'est pas là, il n'a pas de communication aisée, c'est compliqué.
            Il y a peu d'écoles bilingues, il y a Poitier, Paris, Toulouse, et Lyon. Donc si on ne peut pas déménager, ce n’est pas évident. Donc beaucoup de parents décident d'envoyer leurs enfants en intégration.
            </p>
        </div>

        <div class="para">
            <p><span class="quest">Est-ce que le fait d'être sourd influe sur l’équilibre ?</span><br><br>
            Oui, par exemple un bébé qui devient sourd, peut être due à une méningite. Ils peuvent y avoir des problèmes d'équilibre dû à ça. Personnellement je n'ai pas eu ce problème car je suis né sourd. Ça dépend des gens. Il y a tellement de possibilités, de manières de devenir sourds. Mon épouse quant à elle a des soucis d’équilibre de temps en temps.</p>
        </div>

        <div class="para">
            <p><span class="quest">Est-ce que votre épouse est-elle née sourde ? </span><br><br>
            On ne sait pas, ses parents ont découvert sa surdité quand elle avait 2-3 ans. Sa maman était professeur d’école et quand elle était enceinte elle à attraper des maladies du a ses élèves ce qui a pu développer le fait qu’elle soit devenue sourde. Il y’a tellement de facteurs qui rentre en compte que c’est très compliqué de savoir.</p>
        </div>

        <div class="para">
            <p><span class="quest">La surdité n'est pas héréditaire ?</span><br><br>
            Non, il y’a seulement 5% d'hérédité. Avant le XIXème siècle, les hommes et les femmes sourd n'avait pas le droit de se marier ensemble, car on pensait que sinon il y aurait de plus en plus de sourds, mais l'on s'est rendu compte que dans 95 % des cas cela ne posait pas de problèmes. Après l'hérédité est une question de génétique, mais il y a tellement de possibilités qu'on ne sait pas à l'avance.</p>
        </div>

        <div class="para">
            <p><span class="quest">Est-ce que tous les sourds savent lire sur les lèvres ? </span><br><br>
        ...
        <div class="para">
            <p><span class="quest">Quelles conséquences ont les masques sur la compréhension d’autre personnes chez les sourds, y’a-t-il un véritable impacte ?  </span><br><br>
            Oui ça a des conséquences. Déjà parce que si je rencontre une personne je ne sais pas si elle parle ou pas. Je ne sais pas trop comment réagir, je suis toujours dans l’hésitation. Dans mon cas ça ne m’impacte pas énormément car je passe souvent par l’écrit et je suis très à l’aise avec la langue des signes. Mais des personnes qui communiquent principalement avec la lecture des lèvres et l’orale sont énormément impactées. Je n’ai pas besoin de de lire sur les lèvres par contre j’ai besoin du visuel, de voir la réaction sur le visage, on voit les mimiques, le mouvement de la bouche, des expressions etc... Sans ça je ne sais pas si la personne est sympathique ou non. Contente ou non, le masque me gêne pour ce genre de situation. L’interprète est obligé d’enlever le masque pour que je puisse voir les expressions.</p>
        </div>
